/**
	* Beam Up Inverted Date Pebble Watchface with 5 second intervals
	* Author: Chris Lewis Editor: Joshua Jiang
	* Date: 15 Janurary 2014
	*/
...
{    
    ...
    if(seconds == 5)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 0, 5), GRect(0, 105, 12, 5), 500, 0);
    }
    else if(seconds == 10)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 12, 5), GRect(0, 105, 24, 5), 500, 0);
    }
    else if(seconds == 15)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 24, 5), GRect(0, 105, 36, 5), 500, 0);
    }
    else if(seconds == 20)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 36, 5), GRect(0, 105, 48, 5), 500, 0);
    }
    else if(seconds == 25)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 48, 5), GRect(0, 105, 60, 5), 500, 0);
    }
    else if(seconds == 30)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 60, 5), GRect(0, 105, 72, 5), 500, 0);
    }
    else if(seconds == 35)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 72, 5), GRect(0, 105, 84, 5), 500, 0);
    }
    else if(seconds == 40)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 84, 5), GRect(0, 105, 96, 5), 500, 0);
    }
    else if(seconds == 45)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 96, 5), GRect(0, 105, 108, 5), 500, 0);
    }
    else if(seconds == 50)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 108, 5), GRect(0, 105, 120, 5), 500, 0);
    }
    else if(seconds == 55)
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 120, 5), GRect(0, 105, 132, 5), 500, 0);
    }
    else if(seconds == 58)  
    {
        animate_layer(inverter_layer_get_layer(bottomInvLayer), GRect(0, 105, 132, 5), GRect(0, 105, 144, 5), 500, 1000);
    }
...
static void window_load(Window *window) {
	...
	text_layer_set_text_color(HTLayer, GColorBlack);
	...
	text_layer_set_text_color(HULayer, GColorBlack);
	...
	text_layer_set_text_color(colonLayer, GColorBlack);
	...
	text_layer_set_text_color(MTLayer, GColorBlack);
	...
	text_layer_set_text_color(MULayer, GColorBlack);
